...
from app.forms import LoginForm, RegistrationForm, EditProfileForm, PostForm, ResetPasswordRequestForm, ResetPasswordForm, CommentForm, SearchForm
...
def index():  
    page = request.args.get('page', 1, type=int)  
    posts = current_user.team_posts().paginate(
...
def register():
    ...
    if form.validate_on_submit():
        user = User(username=form.username.data, 
                    ...
                    position_id=form.position.data.id,
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        current_user.position_id = form.position.data.id
        ...
        form.position.data = current_user.position_id
